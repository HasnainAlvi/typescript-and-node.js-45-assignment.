...
let favourite_number :number=56;
...
let person_Name:string= "hasnainalvi";
...
let names:string[]=["hasnain","haider","alvi"];
...
let guests : string[]=["aley","rohul","imran","zain"];
...
//guest list
let guestlist :string[]=["aley","rohul","imran","zain"];
...
guests.forEach(guests=>{console.log(`dear ${guests},youre still invited to dinner.`);
});
...
let places:string[]=["pakistan","germany","iran","france","egypt"];
...
let lanuages:string[]= ["Arabic" ,"Urdu" ,"English", "Hindi","Balochi" ,"Sindhi","Punjabi"]
...
// Array of usernames
const usernames: string[] = ["admin", "Eric", "Alvi", "hassan", "imran"];
...
const users: string[] = ["admin", "Eric", "Ali", "wali", "aley"];
...
// • Make a list of five or more usernames called current_users.
 ...
 const current_users: string[] = ["Ali", "Wali", "Aley", "Hassan", "Imran"];
 
 // List of new users
 const new_users: string[] = ["asif", "kazim", "moosa", "Ali", "Imran"];
...
const favoritePizzas: string[] = ['beaf', 'Tikka', 'BBQ Chicken'];
...
let magician:string[]=["Ali","moosa","don" ];
function 
...
const Magicians3: string[] = ["Ali", "moosa", "don"];
...
const myCar: car = createCar('', 'BMW', { color: "Black", year:"2024"})
console.log(myCar)
